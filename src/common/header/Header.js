...
const Header = (props) => {
    ...
    const inputRegisterPasswordChangeHandle = (e) => {
        ...
        <Fragment>
            <div className="header">
                ...
                {!loggedIn ?
                    ...
                    :
                    <div className="loginButton">
                        <Button variant="contained" color="default" onClick={logoutHandle}>LOGOUT</Button>
                    </div>
                }
                        ...
                        <CardContent>
                            ...
                            <TabPanel value={value} index={0}>
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="username" type="text" name="username" onChange={inputUserNameChangeHandler} />
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="password" type="password" name="password" onChange={inputLoginPasswordChangeHandler} />
                            ...
                            <TabPanel value={value} index={1}>
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="firstname" type="text" name="firstname" onChange={inputFirstnameChangeHandler} />
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="lastname" type="text" name="lastname" onChange={inputLastnameChangeHandler} />
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="email" type="email" name="email" onChange={inputEmailChangeHandler} />
                                ...
                                <FormControl required className="formControl">
                                    <InputLabel htmlFor="password">Password</InputLabel>
                                    <Input required id="password" type="password" name="password" onChange={inputRegisterPasswordChangeHandle} />
                                ...
                                <FormControl required className="formControl">
                                    ...
                                    <Input required id="contact" type="number" name="contact" onChange={inputContactChangeHandler} />
